#!/usr/bin/env python3
"""Tiny save-slot API for the Zeliard container.
...
class Handler(BaseHTTPRequestHandler):
    server_version = "zeliard-saves/1.0"
    ...
    def _route(self):
        ...
        return parts  # e.g. ["api","saves","auto"]
...
def main():
    ...
    print(f"[keen123] saves-api on 127.0.0.1:{PORT} -> {SAVE_DIR}", flush=True)
    try:
        srv.serve_forever()
